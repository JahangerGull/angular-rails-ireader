...
coggno.config(function($routeProvider){
  $routeProvider.
    when('/', {controller:CoggnoDocumentCtrl, templateUrl:'/assets/documents/index.html'}).
    when('/new', {controller:CoggnoDocumentCtrl, templateUrl:'/assets/documents/new.html'}).
    when('/show/:id', {controller:CoggnoDocumentCtrl, templateUrl:'/assets/documents/show.html'}).
    when('/documents/:id', {controller:CoggnoDocumentDetailCtrl, templateUrl:'/assets/documents/show.html'}).
