...
coggno.config(function($routeProvider){
  $routeProvider.
    when('/', {controller:CoggnoDocumentCtrl, templateUrl:'/assets/documents/index-5c48134779b67e3ea044794b708c2be4.html'}).
    when('/new', {controller:CoggnoDocumentCtrl, templateUrl:'/assets/documents/new-105801528da649d12b57ef8090fb7614.html'}).
    when('/show/:id', {controller:CoggnoDocumentCtrl, templateUrl:'/assets/documents/show-362061881f8b6ffc25fc60dba17a4525.html'}).
    when('/documents/:id', {controller:CoggnoDocumentDetailCtrl, templateUrl:'/assets/documents/show-362061881f8b6ffc25fc60dba17a4525.html'}).
